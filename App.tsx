...
const App: React.FC = () => {
  ...
  const getFriendlyError = (err: any) => {
    ...
    if (message.includes('404') || message.includes('not found for API version')) {
      return 'Gemini-Modell nicht verfügbar (404). Das gewählte Modell wird in deinem Projekt/Endpoint nicht unterstützt. Bitte nutze Gemini 3.1 Flash oder prüfe die freigegebenen Modelle.';
    }
